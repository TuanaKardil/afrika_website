...
| clean_content | Gemini 2.5 Flash-Lite | 0.0 | 4096 | Score 5+ only (after translate) |
| classify | GPT-5 Nano | 0.0 | 200 | Score 5+ only |
| hashtags | Gemini 2.5 Flash-Lite | 0.2 | 300 | Score 5+ only |
...
| **Score 5+ is published** | 1-4 are dropped (not translated, not classified). |
