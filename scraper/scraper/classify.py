...
_SECTORS = [
    ...
    "gayrimenkul-konut", "havacilik-sivil-havacilik", "hvac-r",
    "kimya-petrokimya", "lojistik-tasimaci", "makine-yedek-parca",
    "mobilya-dekorasyon", "perakende-e-ticaret", "saglik-saglik-turizmi",
    "teknoloji-yazilim", "turizm-otelcilik", "diger-sektor",
    # merged: telekomunikasyon->teknoloji-yazilim, ilac-tibbi-cihaz->saglik-saglik-turizmi
    # merged: fintech-dijital-odeme->teknoloji-yazilim, yenilenebilir-enerji->enerji
    # deleted: fuarcilik-etkinlik
]
