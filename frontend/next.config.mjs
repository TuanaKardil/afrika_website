...
const nextConfig = {
  ...
  // The "?sayfa=N" -> "/sayfa/N" redirects live in middleware.ts, not here:
  // next.config redirects() append the original query string to the
  // destination, which made "?sayfa=1" redirect to itself in a loop.
};
